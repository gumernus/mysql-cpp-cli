...
bin:
	g++ -std=c++17 -O3 -Wall -Wextra -Wpedantic ${botan_inc} ${mysql_inc} -o ${output} ${name}.cpp ${botan_link} ${mysql_link}
dbg:
	g++ -std=c++17 -ggdb3 -Og -Wall -Wextra -Wpedantic ${botan_inc} ${mysql_inc} -o ${output} ${name}.cpp ${botan_link} ${mysql_link}
prof:
